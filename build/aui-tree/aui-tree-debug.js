...
}, '1.5.0' ,{skinnable:false, requires:['aui-tree-data','aui-io','json','querystring-stringify']});
...
AUI.add('aui-tree', function(A){}, '1.5.0' ,{use:['aui-tree-data', 'aui-tree-node', 'aui-tree-view'], skinnable:true});
